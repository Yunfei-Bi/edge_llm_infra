...
namespace StackFlows
{
    ...
    public:
        ...
        void stop_subscriber_work_id(const std::string &zmq_url);
        void subscriber(const std::string &zmq_url,
                        const pzmq::msg_callback_fun &call);
        int send_raw_to_pub(const std::string &raw);
        int send_raw_to_usr(const std::string &raw);
        void set_push_url(const std::string &url);
        void cear_push_url();
        static int send_raw_for_url(const std::string &zmq_url,

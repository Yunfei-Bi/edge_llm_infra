...
{
    std::string sample_json_str_get(const std::string &json_str,
    ...
    bool decode_stream(const std::string &in,
                       const std::string &out,
                       std::unordered_map<int, std::string> &stream_buff);
    
    std::string unit_call(const std::string &unit_name,
                          const std::string &unit_action,
                          const std::string &data);
    void unit_call(const std::string &unit_name,
                   const std::string &unit_action,
                   const std::string &data,

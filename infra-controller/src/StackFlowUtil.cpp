...
std::string StackFlows::sample_get_work_id(int work_id_num,
...
bool StackFlows::decode_stream(const std::string &in,
                               std::string &out,
...
std::string StackFlows::unit_call(const std::string &unit_name,
                                  const std::string &unit_action,
                                  const std::string &data)
{
    std::string value;
    pzmq _call(unit_name);
    _call.call_rpc_action(unit_action, data, [&value](pzmq *_pzmq, const std::shared_ptr<pzmq_data> &raw)
                          { value = raw->string(); });
}

void StackFlows::unit_call(const std::string &unit_name,
                           const std::string &unit_action,
                           const std::string &data,
                           std::function<void(const std::shared_ptr<StackFlows::pzmq_data> &)> callback)
{
    ...
    _call.call_rpc_action(unit_action, data, [callback](StackFlows::pzmq *_pzmq, const std::shared_ptr<StackFlows::pzmq_data> &raw)
                          { callback(raw); });
}

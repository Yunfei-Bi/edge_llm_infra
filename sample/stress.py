...
class ConnectionTester:
    ...
    def run_test(tester, num_connections, num_threads):
        ...
        with ThreadPoolExecutor(max_workers=nu_threads) as executor:
        ...
        avg_time = sum(connection_times) / len(connections_times)
...
def main():
    ...
    parser.add_argument('--port', type=int, default=10001, help='Servre port')
    ...
    run_test(tester, args.connectins, args.threads)
